...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-19 13:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c22534eb-25c1-4a59-9d69-f0d318842f3c.git
$ cd c22534eb-25c1-4a59-9d69-f0d318842f3c
```
